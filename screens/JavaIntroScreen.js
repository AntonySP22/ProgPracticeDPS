...
const JavaIntroScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Fundamentos de Java</Text>
      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.content}>
          <Text style={styles.description}>
            Domina la programación orientada a objetivos con Java. Desde entrada básica hasta manejo de excepciones, desarrolla aplicaciones funcionales y comprende su uso en Android y sistemas empresariales.
          </Text>

          <View style={styles.detailsContainer}>
            <View style={styles.detailBox}>
              <Text style={styles.detailBoxTitle}>10 horas</Text>
              <Text style={styles.detailBoxText}>Teoría y práctica</Text>
            </View>
            <View style={styles.detailBox}>
              <Text style={styles.detailBoxTitle}>50</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('JavaTheoryScreen')}
          >
            <Image
...
export default JavaIntroScreen;