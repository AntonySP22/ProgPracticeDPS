...
const HTMLIntroScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Introducción a HTML</Text>
      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.content}>
          <Text style={styles.description}>
            Aprende a crear estructuras web desde cero. Domina etiquetas esenciales, formularios, enfoques multimedia. Construye tu primera página web responsive paso a paso.
          </Text>

          <View style={styles.detailsContainer}>
            <View style={styles.detailBox}>
              <Text style={styles.detailBoxTitle}>6 horas</Text>
              <Text style={styles.detailBoxText}>Teoría y práctica</Text>
            </View>
            <View style={styles.detailBox}>
              <Text style={styles.detailBoxTitle}>30</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('HTMLTheoryScreen')}
          >
            <Image
...
export default HTMLIntroScreen;