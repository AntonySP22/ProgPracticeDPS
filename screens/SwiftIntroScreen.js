...
const SwiftIntroScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Introducción a Swift</Text>
      ...
      <ScrollView style={styles.scrollContainer}>
        ...
        <View style={styles.content}>
          <Text style={styles.description}>
            Aprende a crear aplicaciones iOS/macOS con Swift, el lenguaje moderno y seguro de Apple. Domina conceptos como opcionales, estructuras y protocolos mientras desarrollas apps funcionales.
          </Text>

          <View style={styles.detailsContainer}>
            <View style={styles.detailBox}>
              <Text style={styles.detailBoxTitle}>12 horas</Text>
              <Text style={styles.detailBoxText}>Teoría y práctica</Text>
            </View>
            <View style={styles.detailBox}>
              <Text style={styles.detailBoxTitle}>35</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('SwiftTheoryScreen')}
          >
            <Image
...
export default SwiftIntroScreen;